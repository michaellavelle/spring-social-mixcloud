package org.springframework.social.mixcloud.config.annotation;
/*
...
/**
 * {@link ImportBeanDefinitionRegistrar} for configuring a {@link MixcloudConnectionFactory} bean and a request-scoped {@link Mixcloud} bean.
 * @author Michael Lavelle
 */
public class MixcloudProviderConfigRegistrar extends AbstractProviderConfigRegistrarSupport {

	public MixcloudProviderConfigRegistrar() {
		super(EnableMixcloud.class, MixcloudConnectionFactory.class, MixcloudApiHelper.class);
	}
