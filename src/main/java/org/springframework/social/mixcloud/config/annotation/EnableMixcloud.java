...
@Documented
@Inherited
@Import(MixcloudProviderConfigRegistrar.class)
public @interface EnableMixcloud {

	/**
	 * The application's App ID as issued by Mixcloud.
	 */
	String appId();
	
	/**
	 * The application's App Secret as issued by Mixcloud.
	 */
	String appSecret();
