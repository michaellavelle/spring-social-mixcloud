...
/**
 * {@link NamespaceHandler} for Spring Social Mixcloud
 * 
 * @author Michael Lavelle
 */
public class MixcloudNamespaceHandler extends AbstractProviderConfigNamespaceHandler {

	@Override
	protected AbstractProviderConfigBeanDefinitionParser getProviderConfigBeanDefinitionParser() {
		return new MixcloudConfigBeanDefinitionParser();
	}
